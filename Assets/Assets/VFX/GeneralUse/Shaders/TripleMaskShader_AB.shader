...
////// Emissive:
                ...
                return fixed4(finalColor,(_MainTex_var.a*i.vertexColor.a*_Mask_var.a*_Mask2_var.a));
            }
            ENDCG
        }
        Pass {
