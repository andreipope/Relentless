...
////// Emissive:
                ...
                float2 node_1120 = (i.uv0+(float2(_Mask_U,_Mask_V)*node_5465.g)+(i.uv0+float2(1,1)));
                float4 _Mask_var = tex2D(_Mask,TRANSFORM_TEX(node_1120, _Mask));
                float3 emissive = (((_MainTex_var.rgb*_Strength*_MainTex_var.a)*_Color.rgb*_Color.a*_MainTex_var.rgb)*i.vertexColor.rgb*i.vertexColor.a*_Mask_var.rgb);
