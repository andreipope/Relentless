...
class AltElement(object):
    def __init__(self, alt_unity_driver, appium_driver, json_data):
        ...
        self.screen_height = str(data['screenHeight'])
        self.screen_width = str(data['screenWidth'])
    ...
    def toJSON(self):
        return '{"name":"' + str(self.name) + '", \
                 ...
                 "screenHeight":"' + str(self.screen_height) + '", \
                 "screenWidth":"' + str(self.screen_width) + '", \
                 "type":"' + str(self.type) + '", \
...
class AltrunUnityDriver(object):
    ...
    def __init__(self, appium_driver,  platform, TCP_IP='127.0.0.1', TCP_FWD_PORT=13000, TCP_PORT=13000, timeout=60,requestSeparator=';',requestEnd='&',deviceID="",screen_width=-1,screen_height=-1):
