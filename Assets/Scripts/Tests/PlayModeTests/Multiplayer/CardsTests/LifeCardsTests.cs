    ...
    public class LifeCardsTests : BaseIntegrationTest
    {
        ...
        public IEnumerator Cactuz()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                    ...
                    Assert.AreEqual(149, (TestHelper.BattlegroundController.PlayerHandCards.Select(card => card.BoardUnitModel.Card.CardPrototype.MouldId)).ToList()[0]);
                    Assert.AreEqual(149, (TestHelper.BattlegroundController.OpponentHandCards.Select(card => card.WorkingCard.CardPrototype.MouldId)).ToList()[0]);
                };
        ...
        public IEnumerator Zap()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                    ...
                    Assert.NotNull(TestHelper.BattlegroundController.PlayerHandCards.Select(card => card.BoardUnitModel.Card.CardPrototype.Name == cardToFind));
                    Assert.NotNull(TestHelper.BattlegroundController.OpponentHandCards.Select(card => card.WorkingCard.CardPrototype.Name == cardToFind));
                };
        ...
        public IEnumerator Keeper()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                    ...
                    Assert.NotNull(TestHelper.BattlegroundController.PlayerBoardCards.Select(card => card.Model.Card.CardPrototype.Name == cardToFind));
                    Assert.NotNull(TestHelper.BattlegroundController.OpponentBoardCards.Select(card => card.Model.Card.CardPrototype.Name == cardToFind));
                };
        ...
        public IEnumerator Shroom()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                   Assert.AreEqual(2, ((BoardUnitModel)TestHelper.BattlegroundController.GetBoardObjectByInstanceId(playerShroomId)).CurrentHp);
                   Assert.AreEqual(3, ((BoardUnitModel)TestHelper.BattlegroundController.GetBoardObjectByInstanceId(opponentIglooId)).CurrentHp);
                };
        ...
        public IEnumerator Sapper()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                   Assert.AreEqual(3, ((BoardUnitModel)TestHelper.BattlegroundController.GetBoardObjectByInstanceId(playerSapperId)).CurrentHp);
                   Assert.AreEqual(3, ((BoardUnitModel)TestHelper.BattlegroundController.GetBoardObjectByInstanceId(opponentSapperId)).CurrentHp);
                };
        ...
        public IEnumerator EverlaZting()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                    ...
                    {
                        if (card.BoardUnitModel.Card.CardPrototype.Name == cardToFind)
                        {
                            playerHasEverlazting = true;
                            break;
                        }
                    ...
                    {
                        if (card.WorkingCard.CardPrototype.Name == cardToFind)
                        {
                            opponentHasEverlazting = true;
                            break;
                        }
        ...
        public IEnumerator Zplitter()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                    ...
                    Assert.AreEqual(2, TestHelper.BattlegroundController.PlayerBoardCards.Select(card => card.Model.Card.CardPrototype.Name == cardToFind).ToList().Count);
                    Assert.AreEqual(2, TestHelper.BattlegroundController.OpponentBoardCards.Select(card => card.Model.Card.CardPrototype.Name == cardToFind).ToList().Count);
                };
        ...
        public IEnumerator Blight()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                    ...
                    {
                        if (card.Model.Card.CardPrototype.Name == cardToFind)
                        {
