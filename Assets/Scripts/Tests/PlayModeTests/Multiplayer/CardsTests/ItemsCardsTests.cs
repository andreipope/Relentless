...
[UnityTest]
        ...
        public IEnumerator Boomstick()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                    Assert.IsTrue(pvpTestContext.GetCurrentPlayer().BoardCards.FindAll(card => card.Model.CurrentDefense == card.Model.Card.Prototype.Defense - 2).Count == 3);
                    Assert.IsTrue(pvpTestContext.GetOpponentPlayer().BoardCards.FindAll(card => card.Model.CurrentDefense == card.Model.Card.Prototype.Defense - 2).Count == 3);
                };
        ...
        public IEnumerator ZedKit()
        {
            return AsyncTest(async () =>
            {
                ...
                Action validateEndState = () =>
                {
                    Assert.AreEqual(2, pvpTestContext.GetCurrentPlayer().BoardCards.FindAll(card => card.Model.CurrentDefense == 5).Count);
                    Assert.AreEqual(2, pvpTestContext.GetOpponentPlayer().BoardCards.FindAll(card => card.Model.CurrentDefense == 5).Count);
                };
