...
namespace Loom.ZombieBattleground
{
    public class CostsLessIfCardTypeInPlayAbility : AbilityBase
    {
        ...
        public override void Action(object info = null)
        {
            ...
            {
                if (PlayerCallerOfAbility.BoardCards.FindAll(x => x.Model.Card.CardPrototype.CardSetType == SetType).Count > 0)
                {
            ...
            {
                gooCost = PlayerCallerOfAbility.BoardCards.FindAll(x => x.Model.Card.CardPrototype.CardSetType == SetType).Count * Value;
            }
