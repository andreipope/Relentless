...
{
    public class DealDamageToUnitAndSwingView : AbilityViewBase<DealDamageToUnitAndSwing>
    {
        ...
        public DealDamageToUnitAndSwingView(DealDamageToUnitAndSwing ability) : base(ability)
        {
