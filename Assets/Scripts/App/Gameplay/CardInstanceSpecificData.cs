...
namespace Loom.ZombieBattleground
{
    public class CardInstanceSpecificData : IReadOnlyCardInstanceSpecificData
    {
        ...
        public CardAbilitiesData Abilities { get; set; }
        ...
        public CardInstanceSpecificData(int damage, int defense, Enumerators.Faction faction, Enumerators.CardType cardType, int cost, CardAbilitiesData abilities)
        {
            Damage = damage;
            Defense = defense;
            Faction = faction;
