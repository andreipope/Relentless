...
namespace UnityEngine.UI
{
    ...
    [AddComponentMenu("UI/Source Input Field", 31)]
    public class SourceInputField
        : Selectable,
        ...
        ICanvasElement
    {
        ...
        public bool custom_allowMobileKeyboard = false;
        ...
        public bool shouldHideMobileInput
        {
            set
            {
                SourceSetPropertyUtility.SetStruct(ref m_HideMobileInput, value);
            }
            get
            {
        ...
        public float caretBlinkRate
        {
            ...
            set
            {
                if (SourceSetPropertyUtility.SetStruct(ref m_CaretBlinkRate, value))
                {
                    if (m_AllowInput)
                        SetCaretActive();
                }
        ...
        public Text textComponent { get { return m_TextComponent; } set { SourceSetPropertyUtility.SetClass(ref m_TextComponent, value); } }

        public Graphic placeholder { get { return m_Placeholder; } set { SourceSetPropertyUtility.SetClass(ref m_Placeholder, value); } }

        public Color selectionColor { get { return m_SelectionColor; } set { SourceSetPropertyUtility.SetColor(ref m_SelectionColor, value); } }

        public SubmitEvent onEndEdit { get { return m_EndEdit; } set { SourceSetPropertyUtility.SetClass(ref m_EndEdit, value); } }

        public OnChangeEvent onValueChange { get { return m_OnValueChange; } set { SourceSetPropertyUtility.SetClass(ref m_OnValueChange, value); } }

        public OnValidateInput onValidateInput { get { return m_OnValidateInput; } set { SourceSetPropertyUtility.SetClass(ref m_OnValidateInput, value); } }

        public int characterLimit { get { return m_CharacterLimit; } set { SourceSetPropertyUtility.SetStruct(ref m_CharacterLimit, value); } }

        // Content Type related

        public ContentType contentType { get { return m_ContentType; } set { if (SourceSetPropertyUtility.SetStruct(ref m_ContentType, value)) EnforceContentType(); } }

        public LineType lineType { get { return m_LineType; } set { if (SourceSetPropertyUtility.SetStruct(ref m_LineType, value)) SetToCustomIfContentTypeIsNot(ContentType.Standard, ContentType.Autocorrected); } }

        public InputType inputType { get { return m_InputType; } set { if (SourceSetPropertyUtility.SetStruct(ref m_InputType, value)) SetToCustom(); } }

        public TouchScreenKeyboardType keyboardType { get { return m_KeyboardType; } set { if (SourceSetPropertyUtility.SetStruct(ref m_KeyboardType, value)) SetToCustom(); } }

        public CharacterValidation characterValidation { get { return m_CharacterValidation; } set { if (SourceSetPropertyUtility.SetStruct(ref m_CharacterValidation, value)) SetToCustom(); } }

        // Derived property
        public bool multiLine { get { return m_LineType == LineType.MultiLineNewline || lineType == LineType.MultiLineSubmit; } }
        // Not shown in Inspector.
        public char asteriskChar { get { return m_AsteriskChar; } set { SourceSetPropertyUtility.SetStruct(ref m_AsteriskChar, value); } }
        ...
        public void ActivateInputField()
        {
            ...
            if (isFocused)
            {
                if (m_Keyboard != null && !m_Keyboard.active)
                {
                    m_Keyboard.active = custom_allowMobileKeyboard;
                    m_Keyboard.text = m_Text;
                }
            }
        ...
        private void ActivateInputFieldInternal()
        {
            ...
            if (TouchScreenKeyboard.isSupported && custom_allowMobileKeyboard)
            {
