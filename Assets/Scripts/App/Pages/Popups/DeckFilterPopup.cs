...
{
    public class DeckFilterPopup : IUIPopup
    {
        ...
        public void Show()
        {
            ...
            Self = Object.Instantiate(
                _loadObjectsManager.GetObjectByPath<GameObject>("Prefabs/UI/Popups/DeckFilterPopup"));
        ...
        {
            _uiManager.HidePopup<DeckFilterPopup>();
        }
        
        private void ButtonSaveHandler()
        {
            ApplySelectedSetType();
            _uiManager.HidePopup<DeckFilterPopup>();
        }
