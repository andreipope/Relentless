...
{
    // Not used, only left for reference
    public class PackOpenerPageWithNavigationBarOld : IUIElement
    {
        private static readonly ILog Log = Logging.GetLog(nameof(PackOpenerPageWithNavigationBarOld));
