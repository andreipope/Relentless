...
namespace Loom.ZombieBattleground
{
    ...
    public class HandPointerPopup
    {
                                ...
                                float rotation = 0)
        {
            ...
            {
                _ownerUnit = _gameplayManager.CurrentPlayer.BoardCards.FirstOrDefault(x => x.Model.Card.Prototype.Name.ToLowerInvariant() ==
            ...
            {
                _targetUnit = _gameplayManager.OpponentPlayer.BoardCards.FirstOrDefault(x => x.Model.Card.Prototype.Name.ToLowerInvariant() ==
